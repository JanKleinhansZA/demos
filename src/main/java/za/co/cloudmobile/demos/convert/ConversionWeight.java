...
public class ConversionWeight implements UnitConversion {
    @Override
    public BigDecimal convertToMetrics(BigDecimal value) {
        return value.divide(BigDecimal.valueOf(2.205),mathContext);
    }

    @Override
    public BigDecimal convertToImperials(BigDecimal value) {
        return value.multiply(BigDecimal.valueOf(2.205));
    }
}
